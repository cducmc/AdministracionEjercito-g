...
Route::get('/cuerpo-ejercito/create', [ArmyCorpsController::class, 'create'])->name('army_corps.create');
Route::post('/cuerpo-ejercito/store', [ArmyCorpsController::class, 'store'])->name('army_corps.store');
